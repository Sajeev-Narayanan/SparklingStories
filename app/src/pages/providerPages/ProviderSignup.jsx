...
const ProviderSignup = () => {
  ...
  return (
    ...
    <div className='md:col-span-2 lg:col-span-1 flex flex-col items-center justify-center'>
        ...
        <textarea name="discription" placeholder='Discription' id="" className='w-[90%] max-h-40 mt-10 text-3xl border-2 border-black rounded-3xl text-center show-scrollbar'></textarea>
